                ...
                <div className="columns">
                    <div className="column">
                        <div className="content">
                            ...
                            <p style={{ color: 'var(--text)' }}>This privacy policy sets out how this website uses and protects any information that you give while using it.</p>
                            <h3 className="title is-5" style={{ color: 'var(--text)' }}>Data Collection</h3>
                            <p style={{ color: 'var(--text)' }}>We may collect the following information:</p>
                            ...
                            <h3 className="title is-5" style={{ color: 'var(--text)' }}>Contact Form</h3>
                            <p style={{ color: 'var(--text)' }}>Data Used: The contact form submission data — IP address, user agent, name,
                                email address, and message — is submitted to the Netlify service for the
                                sole purpose of spam checking.</p>
                            <h3 className="title is-5" style={{ color: 'var(--text)' }}>Links To Other Websites</h3>
                            <p style={{ color: 'var(--text)' }}>This website may contain links to other
                            ...
                            <h3 className="title is-5" style={{ color: 'var(--text)' }}>Amazon Affiliate Links</h3>
                            <p style={{ color: 'var(--text)' }}>This website is a participant in the Amazon Services LLC Associates Program,
                            ...
                            <h3 className="title is-5" style={{ color: 'var(--text)' }}>Google Analytics</h3>
                            <p style={{ color: 'var(--text)' }}>Google Analytics tracks Website usage and
                            ...
                            <h3 className="title is-5" style={{ color: 'var(--text)' }}>Cookies</h3>
                            <p style={{ color: 'var(--text)' }}>We may log information using cookies, which are small data
