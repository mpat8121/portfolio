                            ...
                            <div className="columns">
                                ...
                                <div className="column">
                                    <form method="post" netlify-honeypot="bot-field" data-netlify="true" name="contact">
                                        ...
                                        <div className="field">
                                            <label htmlFor="Name" className="label" style={{ color: 'var(--text)' }}>Name</label>
                                        ...
                                        <div className="field">
                                            ...
                                            <div className="control has-icons-left has-icons-right">
                                                <input className="input is-danger" name="Email" type="email" placeholder="Email input" />
                                        ...
                                        <div className="field">
                                            <label htmlFor="Message" className="label" style={{ color: 'var(--text)' }}>Message</label>
                                            <div className="control">
